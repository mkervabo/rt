...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/05 15:31:25 by mkervabo          #+#    #+#             */
/*   Updated: 2019/11/12 14:13:10 by gfranco          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static struct s_shape_record g_shapes[] = {
	[SHAPE_SPHERE] = { "SPHERE", (void *)hit_sphere, (void *)read_sphere,
		(void *)free_sphere },
	[SHAPE_CYLINDER] = { "CYLINDER", (void *)hit_cylinder,
		(void *)read_cylinder, (void *)free_cylinder },
	...
	[SHAPE_BOX] = { "BOX", (void *)hit_box, (void *)read_box,
		(void *)free_box },
	[SHAPE_TRIANGLE] = { "TRIANGLE", (void *)hit_triangle,
		(void *)read_triangle, (void *)free_triangle },
	[SHAPE_DISK] = { "DISK", (void *)hit_disk, (void *)read_disk,
		(void *)free_disk},
	[SHAPE_PARABOLOID] = { "PARABOLOID", (void *)hit_paraboloid,
		(void *)read_paraboloid, (void *)free_paraboloid },
	[SHAPE_CSG] = { NULL, (void *)hit_csg, NULL, (void *)free_csg },
...
t_shape				*read_shape(t_toml_table *toml)
{
	...
	{
		if (g_shapes[i].name
			&& ft_strcmp(type->value.string_v, g_shapes[i].name) == 0)
